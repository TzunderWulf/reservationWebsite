...
require('../includes/validation-reservervation.php'); // validation for form
...
<body>
    ...
    <main>
        ...
        <form action="" method="post">
            ...
            <div>
                ...
                <input type="text" id="license-plate" name="license-plate" maxlength="8"
                       value="<?= $licensePlate ?>">
    ...
    <!-- <footer><p>Made with the power of PHP</p></footer> -->
</body>
</html>